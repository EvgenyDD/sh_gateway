...
typedef struct {
    ...
    OD_obj_record_t o_1018_identity[8];
    ...
    OD_obj_record_t o_6201_th_sensors[4];
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_power = {
        {
            .dataOrig = &OD_RAM.x6000_power.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6000_power.energy,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x6000_power.power,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        },
    ...
    .o_6201_th_sensors = {
        {
            .dataOrig = &OD_RAM.x6201_th_sensors.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6201_th_sensors.temp_cpu,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x6201_th_sensors.temp_aht,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x6201_th_sensors.hum_aht,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x1018, 0x08, ODT_REC, &ODObjs.o_1018_identity, NULL},
    ...
    {0x6201, 0x04, ODT_REC, &ODObjs.o_6201_th_sensors, NULL},
